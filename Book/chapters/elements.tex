...
\Level 3 {Other precisions}

If you need numerical precision beyond double,
\indextermsub{quadruple}{precision}\index{quadruple precision|see{precision, quad}}
is supported in \cppstandard{23} through \indexcstd{float128_t}.
