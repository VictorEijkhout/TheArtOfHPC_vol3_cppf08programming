...
\begin{block}{Practical note}
  ...
  \end{lstlisting}
  However, some features are taken from the \indexheader{ranges-v3} library,
  and
  \begin{lstlisting}
...
\Level 1 {Parallel execution policies}
...
\Level 1 {Classification of algorithms}

(Taken from a lecture by Dietmar K\"uhl at CppCon 2017, as per its copyright notice.)

\Level 2 {Non-parallel algorithms}

\Level 3 {Order $O(1)$ algorithms}
...
\Level 3 {Order $O(\log n)$ algorithms}
...
\Level 3 {Heap algorithms}

\indexc{make_heap},
\indexc{sort_heap},

\Level 3 {Permutation algorithms}

\indexc{is_permutation},
\indexc{next_permutation},
\indexc{prev_permutation},

\Level 3 {Overlapping algorithms}

\indexc{copy_backward},
\indexc{move_backward},

\Level 3 {Renamed algorithms}

\indexc{accumulate},
\indexc{partial_sum},

\Level 3 {Oddball algorithms}

\indexc{iota},
\indexc{sample},
\indexc{shuffle},

\Level 2 {Parallel algorithms}

\Level 3 {Map algorithms}
