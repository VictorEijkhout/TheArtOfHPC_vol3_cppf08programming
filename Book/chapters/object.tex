...
\Level 1 {First examples: points in the plane}
...
\begin{slide}{Constructor and data initialization}
...
\end{lstlisting}
\columnbreak
\verbatimsnippet{constructoruse}
\end{multicols}
\end{slide}
...
\Level 1 {Data members, introduction}
...
\emph{prototype}\index{prototype!of class method}
of a class method,
