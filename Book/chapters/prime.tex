...
\prerequisite{\textbookref{sec:expr}}
...
\prerequisite{\textbookref{sec:if}}
...
\prerequisite{\textbookref{sec:for}}
...
\prerequisite{\textbookref{ch:function}}
...
\prerequisite{\textbookref{sec:loopuntil}}
...
\begin{exercise}
  ...
  Use the \n{primegenerator} class you developed in exercise~\textbookref{ex:prime:sequence}.
...
\prerequisite{\textbookref{sec:exception}}
...
\prerequisite{\textbookref{sec:map}}
...
which you can learn about in section~\textbookref{sec:std-optional}.
...
\prerequisite{\textbookref{sec:range-iter}}
...
Use the \n{cxxopts} package (section~\textbookref{sec:cxxoptlib})
...
\begin{comment}
  ...
  a~\n{struct} functions to bundle together a number of data item.
